namespace MVCHomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶相關資訊Repository Get客戶相關資訊Repository()
		{
			var repository = new 客戶相關資訊Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶相關資訊Repository Get客戶相關資訊Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶相關資訊Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
