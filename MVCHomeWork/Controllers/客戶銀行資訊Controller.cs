...
namespace MVCHomeWork.Controllers
{
    public class 客戶銀行資訊Controller : Controller
    {
        ...
        public ActionResult Index(客戶銀行資訊 customerBankInfo)
        {
            ...
            if (customerBankInfo.帳戶名稱 != null) { data = db.客戶銀行資訊.Where(p => p.帳戶名稱.Contains(customerBankInfo.帳戶名稱)); }
            if (customerBankInfo.帳戶號碼 != null) { data = db.客戶銀行資訊.Where(p => p.帳戶號碼.Contains(customerBankInfo.帳戶號碼)); }
           // if (customerBankInfo.客戶資料 != null) { data = db.客戶銀行資訊.Where(p => p.客戶資料.客戶名稱.Contains(customerBankInfo.客戶資料.客戶名稱)); }
